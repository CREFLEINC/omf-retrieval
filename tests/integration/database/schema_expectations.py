...
EXPECTED_KEY_CONSTRAINTS = {
    ...
    "uq_search_policy_manifests_config_hash": (
        "search_policy_manifests",
        "u",
        ("config_hash",),
        None,
...
EXPECTED_CHECK_CONSTRAINTS = {
    ...
    "ck_search_policy_manifests_config_hash_sha256": (
        "search_policy_manifests",
        ("config_hash",),
        "CHECK (config_hash::text ~ '^[0-9a-f]{64}$'::text)",
    ),
    "ck_search_policy_manifests_snapshot_object": (
        "search_policy_manifests",
        ("snapshot",),
...
EXPECTED_NON_ID_DEFAULTS = {
    ...
    ("search_policy_manifests", "created_at"): "now()",
